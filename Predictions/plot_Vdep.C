...
//  TFile *f1, *f2, *f3, *f4, *f5, *f6, *f7, *f8, *f9, *f10, *f11, *f12, *f13, *f14, *f15, *f16, *f17, *f18, *f19, *f20;
 ...
 TFile * f1 = new TFile("./Vdep_L1.root");     
//  std::ifstream f2("./VdepEvol_Vdep_TIB_L2.root");
// std::ifstream  f3("./VdepEvol_Vdep_TIB_L3.root");
//  std::ifstream f4("./VdepEvol_Vdep_TIB_L4.root");
//  std::ifstream f5("./deltavfd_5.txt");
// std::ifstream f6("./deltavfd_6.txt");
//  std::ifstream f7("./deltavfd_7.txt");
//  std::ifstream f8("./deltavfd_8.txt");
//  std::ifstream f9("./deltavfd_9.txt");
// std::ifstream  f10("./deltavfd_10.txt");
//  std::ifstream f11("./deltavfd_11.txt");
//  std::ifstream f12("./deltavfd_12.txt");
// std::ifstream  f13("./deltavfd_13.txt");
//  std::ifstream f14("./deltavfd_14.txt");
//  std::ifstream f15("./deltavfd_15.txt");
//  std::ifstream f16("./deltavfd_16.txt");
//  std::ifstream f17("./deltavfd_17.txt");
//  std::ifstream f18("./deltavfd_18.txt");
// std::ifstream  f19("./deltavfd_19.txt");
// std::ifstream  f20("./deltavfd_20.txt");
...
// For the axis labels:
  ...
  pad2->SetFrameLineWidth(3);
    ...
    hVdep->GetYaxis()->SetLabelSize(0.05);
    hVdep->SetTitle("");
    // hVdep->GetXaxis()->SetTicks("+-");
...
//########
  ...
  //########
                ...
                TLatex *t3 = new TLatex(57500000,355,"Simulation");
        t3->SetTextFont(52);
        t3->SetTextAlign(11);
 ...
 c1->Update();
 c1->SaveAs("Vdep_vs_Time.pdf");
 c1->SaveAs("Vdep_vs_Time.root");
}
