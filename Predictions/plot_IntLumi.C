...
//  TFile *f1, *f2, *f3, *f4, *f5, *f6, *f7, *f8, *f9, *f10, *f11, *f12, *f13, *f14, *f15, *f16, *f17, *f18, *f19, *f20;
 ...
 TFile * f1 = new TFile("./VdepEvol_IntLumi.root");     
...
// For the axis labels:
  ...
  pad2->SetFrameLineWidth(3);
    ...
    hVdep->GetXaxis()->SetTitleOffset(1.01);
...
//########
        ...
        // t2->DrawLatex(306000000,497,"Expected Run 3 L_{int} = 260 fb^{-1}");
        TLatex *t2 = new TLatex();
        t2->SetTextFont(52);
        // t2->SetTextAlign(11);
        t2->SetTextAngle(90);
